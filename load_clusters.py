...
def load_clusters(datadir, filt, start_block, end_block, tracked = False, file_startclust = False,rawdatadir=False, multi_probe=False, probeNumber=1, scrubbed = False):
    """
    ...
    neurons = []
    os.chdir(datadir)
    fileList = mbt.makeFileList(datadir, file_startclust = file_startclust, rawdatadir=False, multi_probe = multi_probe, start_block = start_block, end_block = end_block, probeNumber = probeNumber)
    if tracked:
